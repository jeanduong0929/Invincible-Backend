...
public class UserService {
  ...
  public UserService(SecurityService securityService, UserRepository userRepo) {
        ...
        .filter(u -> {
          ...
          try {
            return u.getUsername().equals(req.getUsername()) &&
                Arrays.equals(hashedPassword, securityService.hashingMethod(
                                                  req.getPassword(), salt));
